...
// URL TITIPAN (Sesuai yang lu kasih)
...
export default function Page() {
  ...
  // -- Parser Toko Utama (ORIGINAL LOGIC) --
  ...
  return (
    <div style={{ background: theme.bg, minHeight: "100vh", color: theme.text, fontFamily: "sans-serif", paddingBottom: 80 }}>
      ...
      <main style={{ padding: 16 }}>
        ...
        {/* LELANG SECTION (DIPERBAIKI DARI POTONGAN) */}
